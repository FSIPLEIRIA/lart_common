...
#ifndef LART_COMMON_POINT_H
#define LART_COMMON_POINT_H
...
template <>
struct std::hash<lart_common::Point> {
    std::size_t operator()(lart_common::Point const& p) const noexcept
    {
